...
const ParkingArea = () => {
    ...
    const columns = [
        ...
        { name: "Parking Area Name", selector: (row) => row.parkingAreaName },
    ...
    const tableData = [
        {
            id: 1,
            propertyName: "Falcon Workspace",
            parkingAreaName: "Bike Parking",
            notes: "-",
            status: "Active",
        },
        {
  ...
  return (
    <div>
        ...
        <div className="bg-white md:flex items-center justify-between p-4 mb-2">
            <div className="text-xl font-semibold">Parking Area</div>
        ...
        <CustomModal isOpen = { isModalOpen } onClose = { closeModal } title = "Add Parking Area" size = "lg">
        <div>
            <ul>
                <li>
                    <label className="text-black block text-sm pb-1">Property name*</label>
                ...
                <li className="mt-3">
                    <label className="text-black block text-sm pb-1">Parking Area Name*</label>
                    <input className="inline-block text-sm py-2 px-3 border border-light-200 rounded-md w-full" input placeholder="Enter Name" />
                </li>
                <li className="mt-3">
                    <label className="text-black block text-sm pb-1">Parking Area Type</label>
                    <select className="inline-block text-sm text-light-600 outline-none py-2 px-3 border border-light-200 rounded-md w-full">
