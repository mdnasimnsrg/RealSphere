...
const ParkingGroupingMaster = () => {
    ...
    const columns = [
        { name: "Parking Grouping Name", selector: (row) => row.parkingGroupingName },
    ...
    const tableData = [
        {
            id: 1,
            parkingGroupingName: "n3",
            propertyName: "Mohanadiah",
  ...
  return (
    <div>
        ...
        <div className="bg-white md:flex items-center justify-between p-4 mb-2">
            <div className="text-xl font-semibold">Parking Grouping Master</div>
            ...
            <div className="bg-white shadow-md rounded-md p-4  overflow-x-auto">
                ...
                <div className="flex flex-wrap gap-4 items-center justify-between mb-4">
                    ...
                    <div className="flex w-full md:w-auto gap-2 flex-1">
                        ...
                        <input
                            type="text"
                            placeholder="Search by Parking group name"
        ...
        <CustomModal isOpen = { isModalOpen } onClose = { closeModal } title = "Add Parking Group" size = "lg">
        <div>
            <ul>
               
                <li className="mt-3">
                    <label className="text-black block text-sm pb-1">Parking Group Name*</label>
                    <input className="inline-block text-sm py-2 px-3 border border-light-200 rounded-md w-full" input placeholder="Enter Parking Group Name" />
                </li>
...
export default ParkingGroupingMaster;
