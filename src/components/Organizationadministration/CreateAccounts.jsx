    ...
    <div>
      ...
      <div className="bg-white shadow-md rounded-md p-4 m-3 text-center">
        <Link
          ...
          className=" bg-blue-500 text-sm text-white py-2 px-6 block w-full rounded-lg"
        >
          {!nextform ? "Next" : "Create"}
        </Link>
        {nextform && (
          <Link
            onClick={() => handleNextform(false)}
            className=" bg-white border border-light-200 text-sm text-black py-2 px-6 block w-full rounded-lg mt-5"
          >
