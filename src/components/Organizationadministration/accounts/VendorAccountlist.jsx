...
const VendorAccountlist = () => {
  ...
  const tableData = [
    {
      id: 1,
      image: "path/to/image.jpg", // Replace with the actual image URL or path
      accountId: "A-336",
      name: "Marcellus",
  ...
  return (
    <div>
      ...
      <div className="bg-white shadow-md rounded-md p-4 flex-wrap flex justify-between">
        <div className="w-full lg:w-width78%">
          <div>
        ...
        <div className="w-full lg:w-width20%">
          <div className="">
