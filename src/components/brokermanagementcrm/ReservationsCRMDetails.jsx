        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div>
            ...
            <div className="mt-4 flex justify-between gap-4">
              <button className="w-fit px-3 bg-red-500 text-white py-2 rounded-lg">
                Cancel Reservation
              </button>
              <button className="w-fit px-3 bg-gray-300 text-gray-700 py-2 rounded-lg ml-4">
                Send Payment Link
              </button>
            </div>
            {/* Quotation Details */}
            <div className="mt-4">
              <div className="flex justify-between items-start">
                ...
                <span className="inline-block ml-4 bg-green-200 text-green-800 text-sm px-3 py-1 rounded-full">
                  Active
                </span>
              </div>
              <div className="flex flex-wrap gap-y-3 gap-x-10 w-full mt-4 p-4 border rounded-lg shadow">
                <div className="">
...
export default ReservationsCRMDetails;
