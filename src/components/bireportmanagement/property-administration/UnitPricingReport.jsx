  ...
  return (
    <div>
      <div className="bg-white flex flex-col md:flex-row gap-2 items-center justify-between p-4 mb-2">
        <div className="text-xl font-semibold">Unit Pricing Report</div>
          ...
          <div className="w-full overflow-x-auto sc-fkSzgi my-4">
            <Table>
              <TableHead className="bg-gray-100">
                {unitPricingData.slice(0, 1).map((data, index) => (
              ...
              <TableBody>
                {unitPricingData.map((data, index) => (
                  <TableRow
...
export default UnitPricingReport;
