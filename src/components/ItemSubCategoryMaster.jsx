  ...
  return (
    <div>
      <div className="bg-white md:flex items-center justify-between p-4 mb-2">
        <div className="text-xl font-semibold">Item Sub Category Master</div>
      </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50 ">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full lg:w-3/4 lg:max-w-4xl h-[90vh] overflow-y-scroll scrollbar-hide">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-semibold">
                Add Item Sub Category Master
              </h2>
              <button
            ...
            <div className="">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  placeholder="Enter a description or remarks..."
                ></textarea>
              </div>
              <div className="mb-6">
                <label className="block text-gray-700 font-medium mb-2">
      ...
      {isOpen1 && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
          <div className="bg-white  rounded-lg shadow-lg p-6 w-full h-[90vh] overflow-y-scroll scrollbar-hide lg:w-3/4 lg:max-w-4xl">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-semibold">
                View Item Sub Category Master
              </h2>
              <button
                className="text-gray-500 hover:text-gray-700"
...
export default ItemSubCategoryMaster;
