                ...
                <div className="grid grid-cols-4 gap-6">
                  ...
                  <div className="p-4 col-span-full lg:col-span-1 bg-white rounded-lg shadow-md">
                    <div className="flex gap-4">
                      ...
                      <div className="w-[80%]">
                        <h3 className="font-semibold mt-5">Manpreet</h3>
                        <button className="mt-[-30px] bg-orange-500 text-white px-3 py-1 rounded float-right">
                          Sale
                        </button>
                      </div>
                    </div>
          ...
          {currentStep === 3 && (
            <div>
              <div className="bg-white p-4 rounded-lg shadow-md">
                {/* Header Section */}
                <div className="flex flex-col sm:flex-row items-center sm:items-start border-b pb-4 flex-wrap justify-center md:justify-start gap-6">
                  ...
                  <div className="relative">
                    <div className="w-40 h-40 sm:w-48 sm:h-48">
                      <img
                        src={img1}
                        alt="User"
                        className="w-40 h-40 sm:w-48 sm:h-48 rounded-md object-cover"
                      />
                      <span className="bg-blue-600 text-white absolute top-2 left-2 px-3 py-1 rounded-md text-sm">
                        Medium
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col w-full sm:w-auto">
                    <h3 className="text-md font-semibold mb-4 sm:mb-6 text-center md:text-left">
                      OPPORTUNITY DETAILS
                    </h3>

                    {/* Contact Info - Now Flexible & Wrapping */}
                ...
                {/* Details Section */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-4 text-sm">
                  <div>
