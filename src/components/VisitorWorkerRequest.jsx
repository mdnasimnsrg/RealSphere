  ...
  const rows = [
    {
      ...
      referenceId: "SR-1270",
      visitorName: "-",
      unitId: "Unit -1 (Lease), UNIT25-1185",
      visitors: 0,
      stayType: "Short",
      entryType: "-",
      entryGate: "Any",
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>Visitors/Workers</TableCell>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <select className="border border-gray-300 rounded px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <option>Received At Gate</option>
...
export default VisitorWorkerRequest;
