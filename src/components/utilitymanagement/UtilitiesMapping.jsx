...
const UtilitiesMapping = () => {
    ...
    const tableData = [
        {
            id: 1,
            propertyNo: "PROP25-327",
            propertyName: "Atelier La View Center",
  ...
  return (
    <div>
        ...
        <div className="bg-white md:flex items-center justify-between p-4 mb-2">
            <div className="text-xl font-semibold">Utilities Mapping</div>
...
export default UtilitiesMapping;
