    ...
    const columns = [
        {
            ...
            selector: (row) => (
                <Link to={`/showcase-site-visit-details`}>
                    {row.JobId} 
                </Link>
            ),
        },
  ...
  return (
    <div>
        ...
        <div className="bg-white md:flex items-center justify-between p-4 mb-2">
            <div className="text-xl font-semibold">Site Visit</div>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                <div className="bg-white w-[515px] p-6 rounded-lg shadow-lg">
                    ...
                    <div className="flex items-center space-x-2 mt-4 text-gray-600">
                        ...
                        <span>&gt;</span>
                        <span className={step === 3 ? "font-medium text-blue-600" : "text-gray-400"}>Scope of Work</span>
                        <span>&gt;</span>
                        <span className={step === 4 ? "font-medium text-blue-600" : "text-gray-400"}>Preview</span>
                    </div>
                    ...
                    {step === 3 && (
                        <div className="mt-4">
                            <div className="mt-4 space-y-3">
                                <h3 className="text-sm font-semibold">Scope Of Work</h3>
                                <textarea 
                                    placeholder="Enter unit details..." 
                                    className="w-full p-2 mt-2 border rounded-md focus:ring focus:ring-blue-300"
                                ></textarea>
                            </div>
                            <div className="mt-4 flex justify-between">
                                ...
                                <button
                                    className={`mt-4 p-2 rounded-md ${selectedProperty ? "bg-blue-600 text-white" : "bg-gray-300 text-gray-500 cursor-not-allowed"}`}
                                    disabled={!selectedProperty}
                                    onClick={() => selectedProperty && setStep(4)}
                                >
                                    Next
                                </button>
                            </div>
...
export default ShowcaseSiteVisit;
