    ...
    const columns = [
        {
            ...
            selector: (row) => (
                <Link to={`/unit-handover-inner-details`}>
                    {row.JobId} 
                </Link>
            ),
        },
    ...
    <div>
        ...
        <div className="flex space-x-4 p-4 overflow-x-auto">
            <Card
                ...
                content="IMO240912-1398"
                subContent="Veer 12 Sep 2024"
            />
            <Card
                icon={"📄"}
                title="Primary Contact"
                content="Samarth"
                subContent="samarth@yopmail.com"
            />
            <Card
                icon={"📄"}
                title="Agreement Detail"
                content="AGR240912-302"
                subContent="12 Sep 2024 - 31 Dec 2999"
            />
            <Card
                icon={"🏢"}
                title="Property Details"
                content="Majd Al Narges"
                subContent="Riyadh , Saudi Arabia"
            />
        </div>
...
export default DetailsUnitHandOver;
