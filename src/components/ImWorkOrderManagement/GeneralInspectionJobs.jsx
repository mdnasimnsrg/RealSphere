    ...
    const columns = [
        {
            ...
            selector: (row) => (
                <Link to={`/general-inspection-jobs-details`}>
                    {row.JobId} 
                </Link>
            ),
        },
  ...
  return (
    <div>
        ...
        <div className="bg-white md:flex items-center justify-between p-4 mb-2">
            <div className="text-xl font-semibold">General Inspection</div>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                <div className="bg-white w-[515px] p-6 rounded-lg shadow-lg">
                    ...
                    <div className="flex items-center space-x-2 mt-4 text-gray-600">
                        ...
                        <span>&gt;</span>
                        <span className={step === 3 ? "font-medium text-blue-600" : "text-gray-400"}>Inspection Items</span>
                        <span>&gt;</span>
...
export default GeneralInspectionJobs;
