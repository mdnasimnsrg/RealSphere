  ...
  const rows = [
    {
      ...
      serviceProviderPersonName: "Ahmad",
      referenceId: "PG2SP250123-156",
      unitNo: "UNIT24-980",
      entryGate: "Gate-A",
    ...
    },
    {
      sno: "2",
      date: "21 Jan 2025",
      serviceProviderName: "TNEB",
      serviceProviderPersonName: "Nasim",
      referenceId: "PG2SP250121-152",
      unitNo: "UNIT24-980",
      entryGate: "Gate-A",
    ...
    <div>
      <div className="bg-white md:flex items-center justify-between p-4 mb-2">
        <div className="text-xl font-semibold">
          Service Provider Entries Report
        </div>
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>Service Provider Person Name</TableCell>
                  <TableCell>Reference ID</TableCell>
                  <TableCell>Visiting Unit No</TableCell>
                ...
                {filteredRows
                  ...
                  .map((row, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>{row.serviceProviderPersonName}</TableCell>
...
export default ServiceProviderEntries;
