...
const ProfessionsSkills = () => {
    ...
    const tableData = [
        ...
        {
            id: "3",
            name: "Movenpick Inspector",
            notes: "Second Floor Inspection",
            status: "Active",
        },
    ];
  ...
  return (
    <div>
        ...
        <div className="bg-white md:flex items-center justify-between p-4 mb-2">
            <div className="text-xl font-semibold">Professions</div>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
                <div className="bg-white w-[400px] rounded-lg shadow-lg p-6 w-3/4 max-w-4xl">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-lg font-semibold">Add Profession</h2>
                        <button
                    ...
                    <div className="">
                        <div className="mb-6">
                            <label className="block text-gray-700 font-medium mb-2">Profession Name</label>
                            <input
                                type="text"
        ...
        {isOpen1 && (
            <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
                <div className="bg-white w-[400px] rounded-lg shadow-lg p-6 w-3/4 max-w-4xl">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-lg font-semibold">View Profession</h2>
                        <button
                            className="text-gray-500 hover:text-gray-700"
...
export default ProfessionsSkills;
