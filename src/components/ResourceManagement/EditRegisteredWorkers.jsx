...
const EditRegisteredWorkersNew = () => {
  ...
  return (
    <div>
        ...
        <div className="bg-white flex justify-between items-center mb-4 p-2">
          ...
          <div className="flex justify-end gap-2 mt-4">
            <button className={`px-4 py-2 rounded-md ${
                activeTab === tabs.length ? "bg-blue-600 text-white" : "bg-gray-300 cursor-not-allowed"
              }`}
              onClick={() => setActiveTab((next) => Math.min(next - 1, tabs.length))}
            >
              Prev
            </button>
            <button
              className={`px-4 py-2 rounded-md ${
                activeTab === tabs.length ? "bg-gray-300 cursor-not-allowed" : "bg-blue-600 text-white"
              }`}
        ...
        <div className="flex border-b">
          ...
          <div className="flex justify-end gap-2 mt-4">
            <button className="px-4 py-2 border border-gray-400 rounded-md">Cancel</button>
            <button className="px-4 py-2 border border-gray-400 rounded-md">Submit</button>
          </div>
            ...
            <p>
                <div className="p-2 m-1">
                    <div className="flex gap-4">
                      ...
                      <div className="bg-white rounded-xl w-width20% p-2">
                        <div className="flex flex-col items-center">
                          <h3 className="text-sm font-semibold mb-8">Profile Picture</h3>
                      ...
                      <div className="bg-white rounded-xl w-width80% p-2">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                          ...
                          <div className="mb-4">
                            ...
                            className={`py-2 px-2 text-sm font-medium rounded-l-lg ${
                                accountType2 === "Yes" ? "bg-blue-500 text-white" : "bg-gray-200"
                            }`}
                            ...
                            className={` py-2 px-2 text-sm font-medium rounded-r-lg ${
                                accountType2 === "No" ? "bg-blue-500 text-white" : "bg-gray-200"
                            }`}
                        ...
                        <div className="mt-4">
                          ...
                          <textarea className="w-full border border-gray-300 p-3 rounded-lg h-20" placeholder="Description" />
                        </div>
                      </div>
                    </div>
                </div>
                ...
                <div className="bg-white flex flex-wrap shadow-md rounded-md p-4 m-3">
                  ...
                  <h2 className="text-sm text-black font-semibold mb-2">Address</h2>
                ...
                <div className="bg-white shadow-md rounded-md p-4 m-3">
                  <h2 className="text-sm text-black font-semibold mb-4">Contact & Other Information</h2>
                  <div className="flex flex-wrap justify-between mt-4">
                    <div className="flex flex-col w-width24%">
                      <label className="text-sm text-gray-500 mb-1">Primary Telephone*</label>
                      <input
                        type="number"
                    ...
                    <div className="flex flex-col w-width24%">
                      <label className="text-sm text-gray-500 mb-1">Primary Mobile*</label>
                      <input
                        type="number"
                    ...
                    <div className="flex flex-col w-width24%">
                      <label className="text-sm text-gray-500 mb-1">Primary Email Address*</label>
                      <input
                        type="text"
            ...
            <p>
              <div className="w-full bg-white shadow-lg rounded-lg p-2">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button onClick={addProofItem} className="text-blue-500 hover:underline">
                    Add New Proof Item
                  </button>
                </div>

                {proofs.map((proof) => (
                  <div key={proof.id} className="p-4 border rounded-lg bg-gray-50 mb-4">
                    <h3 className="text-md font-semibold mb-2">Company Aadhaar</h3>

                    <div className="grid grid-cols-6 gap-4 items-center">
                      {/* Name */}
                      <div>
                        <label className="text-sm font-medium">Name As In Proof*</label>
                        <input
                          type="text"
                          ...
                          onChange={(e) =>
                            setProofs((prev) =>
                              prev.map((p) =>
                                p.id === proof.id ? { ...p, name: e.target.value } : p
                              )
                            )
                          }
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setProofs((prev) =>
                              prev.map((p) =>
                                p.id === proof.id ? { ...p, idNumber: e.target.value } : p
                              )
                            )
                          }
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setProofs((prev) =>
                              prev.map((p) =>
                                p.id === proof.id ? { ...p, validFrom: e.target.value } : p
                              )
                            )
                          }
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setProofs((prev) =>
                              prev.map((p) =>
                                p.id === proof.id ? { ...p, validTo: e.target.value } : p
                              )
                            )
                          }
                        />
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setProofs((prev) =>
                              prev.map((p) =>
                                p.id === proof.id ? { ...p, country: e.target.value } : p
                              )
                            )
                          }
                        >
                      ...
                      {/* Mandatory Verify */}
                      <div>
                        <label className="text-sm font-medium">Mandatory Verify*</label>
                        <div className="flex space-x-2">
                          <button
                            className={`px-4 py-2 rounded-md ${
                              proof.mandatoryVerify ? "bg-blue-500 text-white" : "bg-gray-300"
                            }`}
                    ...
                    <div className="mt-4 flex space-x-4 items-center">
                      <div className="w-40 h-40 border-dashed border-2 border-gray-300 flex items-center justify-center rounded-md">
                        <label className="cursor-pointer">
                          ...
                          />
                          {proof.document ? (
                            <img src={URL.createObjectURL(proof.document)} alt="Document" className="h-full w-full object-cover rounded-md" />
                          ) : (
                            <span className="text-gray-500">Upload Documents Here</span>
                          )}
                        </label>
                      </div>
...
export default EditRegisteredWorkersNew;
