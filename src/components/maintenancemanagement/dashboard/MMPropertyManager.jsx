...
const MMPropertyManagerDashboard = () => {
  ...
  return (
    <div>
      ...
      <div className="md:flex flex-wrap mt-2 md:space-x-4 p-4">
      ...
      <div className="md:flex md:space-x-4 p-4 flex-wrap">
        <div className="flex-1 space-y-4">
          {data.summaryCards.map((card, index) => (
            <div
              key={index}
...
export default MMPropertyManagerDashboard;
