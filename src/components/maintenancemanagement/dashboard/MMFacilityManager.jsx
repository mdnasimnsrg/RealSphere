...
const MMFacilityManagerDashboard = ({ isSidebarOpen }) => {
    ...
    <div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center border rounded-md p-2 shadow-sm bg-gray-50">
            ...
            <select className="focus:outline-none bg-transparent text-gray-700 font-medium cursor-pointer">
              ...
              <option value="alNawras">Movenpick Jeddah Al Nawras</option>
              <option value="atelier">Atelier La View Center</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="col-span-2 bg-white shadow-md rounded-md p-6 flex flex-col">
...
export default MMFacilityManagerDashboard;
