...
function EditMaintenanceServiceRequest() {
  ...
  return (
    <div>
      ...
      <form className="">
        ...
        <div className="flex fixed bottom-0 gap-4 justify-between w-full lg:w-fit right-0 px-4">
          <button
            type="button"
...
export default EditMaintenanceServiceRequest;
