...
const AddRegisteredWorkers = () => {
  ...
  return (
    <div>
      <div className="bg-white flex justify-between items-center flex-wrap mb-4 p-2">
        ...
        <div className="flex justify-between w-full lg:w-fit lg:justify-end gap-2 mt-4 px-4">
          <button
          ...
          <p>
            ...
            <div className="bg-white shadow-md rounded-md p-4 m-3">
              ...
              <div className="flex flex-wrap justify-between mt-4 gap-4">
                <div className="flex flex-col lg:w-width24% w-full">
                  <label className="text-sm text-gray-500 mb-1">
                    Primary Telephone*
                  </label>
                  <input
            ...
            <div className="w-full bg-white shadow-lg rounded-lg p-2">
              ...
              {proofs.map((proof) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-6 gap-4 items-center">
                    {/* Name */}
                    <div>
