...
const Company = () => {
    ...
    const columns = [
                ...
                {dropdownVisible && selectedRowId === row.id && (
                    <div className="absolute z-10 bg-white shadow-md rounded-md p-1 mt-2 w-[80px]">
                        ...
                        <li className="py-1 px-3 hover:bg-gray-200 cursor-pointer">
                                <Link to="/edit-company" className="block w-full">
                                 Edit
                                </Link>
                            </li>
                            <li
        ...
        {
            name: "Logo",
            selector: (row) => <div className="flex"><Link to='/company-details' className="block self-center mr-2"><img  src={row.logo} alt="Profile" style={{ width: 30, height: 30, borderRadius: '50%' }} /></Link></div>,
        },
        { name: "Company Code", selector: (row) => row.companyCode },
        { name: "Company Name", selector: (row) => row.companyName },
        { name: "City", selector: (row) => row.city },
        { name: "Country", selector: (row) => row.country },
        { name: "Currency", selector: (row) => row.currency },
        { name: "Tax Registration", selector: (row) => row.tax },
        { name: "Tax Group", selector: (row) => row.taxGroup },
        { name: "Total Tax Rate", selector: (row) => row.totalTaxRate },
            ...
            <div className="bg-white shadow-md rounded-md overflow-x-auto p-4">
                ...
                <div className="flex flex-wrap gap-4 items-center justify-between mb-4">
                    ...
                    <div className="flex w-full md:w-auto gap-2 justify-start md:justify-end">
                        ...
                        <Link to='/create-company' className="flex bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                        New Company
                        </Link>
