...
const ResourceMaster = () => {
  ...
  const users = [
    ...
    },
    {
      ...
      name: "Asahel",
      phone: "+91 9587412356",
      email: "asahel@propertyautomate.com",
      avatar: "",
    },
    {
      id: 3,
      name: "Hind",
      phone: "+971 587896236",
      email: "hind@propertyautomate.com",
      avatar: "",
    },
    {
      id: 4,
    ...
    <div>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 lg:w-3/4 w-full lg:max-w-4xl h-[90vh] overflow-y-auto scrollbar-hide">
              ...
              <div className="border rounded w-full py-4 px-3 bg-gray-100 flex items-center justify-center cursor-pointer">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M4 16v4a2 2 0 002 2h12a2 2 0 002-2v-4m-7 0l-3-3m0 0l-3 3m3-3v-12a2 2 0 012-2h10a2 2 0 012 2v12m-9 0h7"
                  />
                </svg>
            ...
            <div className="mt-6 flex justify-end">
              {" "}
              {/* Buttons */}
              <button className="bg-gray-300 text-gray-700 px-4 py-2 rounded mr-2 hover:bg-gray-400">
                Cancel
              </button>
      ...
      {isOpen4 && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50 ">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full lg:w-3/4 lg:max-w-4xl h-[90vh] overflow-y-auto scrollbar-hide">
            <div className="flex justify-between items-center mb-6">
            ...
            <div className="p-4 flex flex-wrap gap-y-5">
              <div className="lg:w-1/2 w-full lg:pr-4 h-[500px] overflow-y-auto">
                {[
                  "Module",
                  "Jobs",
                  "Profession",
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700">
                      Hours Rate<span className="text-red-500">*</span>
                    </label>
                    <div className="relative">
                      <input
                        type="number"
                        className="w-full mt-1 p-2 border rounded-lg text-gray-700 pr-6"
              ...
              <div className="lg:w-1/2 w-full lg:pl-4 border-l">
                <label className="block text-sm font-medium text-gray-700">
                  Search Users Name <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
      ...
      {isOpen1 && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full lg:w-3/4 lg:max-w-4xl max-h-[90vh] overflow-y-auto scrollbar-hide">
            <div className="flex justify-between items-center mb-6">
            ...
            <div className="">
              <div className="p-1">
                ...
                <div className="grid grid-cols-3 gap-4 mt-6 text-sm">
                  <p>
                    <strong>Resource Type:</strong> Users
                  </p>
                  <p>
                    <strong>Resource ID:</strong> R20250110-101
                  </p>
                  <p>
                    <strong>Department:</strong> Security Department
                  </p>
                  <p>
                    <strong>Job:</strong> Security guard
                  </p>
                  <p>
                    <strong>Module Assigned:</strong> Lease & Sales Management
                  </p>
                  <p>
                    <strong>Working Calendar:</strong> 09:30 am - 06:30 pm
                  </p>
                  <p>
                    <strong>Daily Rate Day:</strong> ₹ 800
                  </p>
                  <p>
                    <strong>Hours Rate:</strong> ₹ 100
                  </p>
                  <p>
                    <strong>Reporting To:</strong> Zyair
                  </p>
                  <p>
                    <strong>Functional Location:</strong> Riyadh
                  </p>
                </div>
              </div>
      ...
      {isOpen2 && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
          <div className="bg-white  rounded-lg shadow-lg p-6 w-full lg:w-3/4 lg:max-w-4xl max-h-[90vh] overflow-y-auto scrollbar-hide">
            ...
            <div className="p-4 flex flex-wrap h-full overflow-y-scroll scrollbar-hide">
              <div className="lg:w-1/2 w-full lg:pr-4 h-full scrollbar-hide overflow-y-auto">
                {[
                  "Module",
                  "Jobs",
                  "Profession",
              ...
              <div className="lg:w-1/2 w-full lg:pl-4 border-l h-full overflow-y-scroll scrollbar-hide">
                <label className="block text-sm font-medium text-gray-700">
                  Search Users Name <span className="text-red-500">*</span>
                </label>
                <input
