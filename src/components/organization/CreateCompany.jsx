  ...
  return (
    <div>
      ...
      <div className="flex border-b w-full overflow-x-auto px-4">
        ...
        <div className="flex justify-end self-end gap-2 mt-4 lg:ml-auto ml-8">
      ...
      <div className="lg:p-4">
        {activeTab === 1 && (
          <p>
            ...
            <div className="bg-white shadow-md rounded-md p-4 m-3">
              ...
              <div className="flex flex-wrap justify-between mt-4 gap-y-3">
            ...
            <div className="bg-white shadow-md rounded-md p-4 m-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <div className="w-full  mt-4">
                    ...
                    <div className="flex flex-nowrap">
                      <button
                        ...
                        onClick={() =>
                          handleAccountTypeChange2("Account Number")
                        }
                      >
                        Account Number
                      </button>
                  ...
                  <div className="w-full lg:w-[19%] mt-4">
        ...
        {activeTab === 2 && (
          <p>
            <div className="flex bg-gray-100 p-6 min-h-screen w-full flex-wrap gap-4 lg:flex-nowrap">
              {/* Sidebar */}
              ...
              {/* Content Section */}
              <div className="lg:w-3/4 w-full bg-white shadow-md rounded-lg p-6">
                {activeTab1 === 1 && (
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Upfront Charges */}
                      <div className="flex justify-between p-3 bg-gray-100 rounded-md flex-wrap gap-y-2">
                        <span className="">Upfront Charges</span>
                        <select className="border border-gray-300 p-2 rounded-md">
              ...
              {proofs.map((proof) => (
                ...
                >
                  ...
                  <div className="mt-4 flex space-x-4 items-center">
                    <div className="px-4 h-40 border-dashed border-2 border-gray-300 flex items-center justify-center rounded-md">
