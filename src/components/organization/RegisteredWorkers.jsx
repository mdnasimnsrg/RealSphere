...
const RegisteredWorkers = () => {
    ...
    const columns = [
        ...
        {
            name: "Image",
            selector: (row) => <div className="flex"><Link to='/register-details' className="block self-center mr-2"><img  src={row.logo} alt="Profile" style={{ width: 30, height: 30, borderRadius: '50%' }} /></Link></div>,
        },
            ...
            <div className="bg-white shadow-md rounded-md overflow-x-auto p-4">
                ...
                <div className="flex flex-wrap gap-4 items-center justify-between mb-4">
                    ...
                    <div className="flex w-full md:w-auto gap-2 justify-start md:justify-end">
                        ...
                        <Link to='/add-register-worker' className="flex bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
