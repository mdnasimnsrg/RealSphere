      ...
      <div className="flex border-b w-full overflow-x-auto scrollbar-hide">
        {tabs.map((tab) => (
          <div
            ...
            className={`flex items-center gap-2 px-4 py-2 cursor-pointer text-nowrap ${
              activeTab === tab.id
...
export default RegisteredWorkerDetails;
